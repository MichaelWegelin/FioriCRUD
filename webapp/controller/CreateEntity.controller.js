sap.ui.define([
	...
	return BaseController.extend("de.wegelin.FioriCRUD.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ZMW_I_EPM_SO", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("ZMW_I_EPM_SO", oData);
