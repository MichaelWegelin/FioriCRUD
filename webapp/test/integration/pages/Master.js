		...
		onTheMasterPage: {
			...
			actions: {
				...
				iRememberTheListItem: function (oListItem) {
					...
					this.getContext().currentItem = {
						...
						title: oBindingContext.getProperty("so_id")
					};
				},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "ZMW_I_EPM_SO (0)"
						}),
						success: function () {
							Opa5.assert.ok(true, "The list header displays 'ZMW_I_EPM_SO (0)'");
						},
				...
				theListShouldBeSortedAscendingOnUnitNumber: function () {
					return this.theListShouldBeSortedAscendingOnField("net_amount");
				},

				theListShouldBeSortedAscendingOnName: function () {
					return this.theListShouldBeSortedAscendingOnField("so_id");
				},
				...
				theListShouldHaveAllEntries: function () {
					...
					// retrieve all ZMW_I_EPM_SO to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "ZMW_I_EPM_SO (" + iExpectedLength + ")"
								}),
								success: function () {
