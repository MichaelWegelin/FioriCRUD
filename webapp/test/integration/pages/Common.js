sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/wegelin/FioriCRUD/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#FioriCRUD-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#FioriCRUD-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("de.wegelin.FioriCRUD.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["de/wegelin/FioriCRUD/localService/mockserver"], function (mockserver) {
