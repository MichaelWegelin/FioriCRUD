sap.ui.define([
	...
	opaTest("MasterList Filtering on net_amount less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("net_amount").
		and.iSelectListItemInViewSettingsDialog("<100 currency_code").
	...
	opaTest("MasterList Filtering on net_amount more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 currency_code").
		and.iPressOKInViewSelectionDialog();
